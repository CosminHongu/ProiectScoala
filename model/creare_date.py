...
def create_all():
    ...
    #Creare pachet_ore
    pachet_ore1 = PachetOre(30, 2000)
    pachet_ore2 = PachetOre(15, 1000)
    ...
    session.add_all([
            ...
            personal_alexandru1, personal_alexandru2, personal_pacurari1, personal_pacurari2, personal_nicolina1, personal_nicolina2,
            personal_copou1, personal_copou2, personal_copou3,
